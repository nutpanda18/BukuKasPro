...
try {
    ...
    foreach ($stmt_chart->fetchAll(PDO::FETCH_ASSOC) as $row) {
        $bulan = (int)$row['bulan'];
        if ($row['jenis_transaksi'] === 'pemasukan') {
            $pemasukan_bulanan[$bulan] = (float)$row['total'];
        } elseif ($row['jenis_transaksi'] === 'pengeluaran') {
            $pengeluaran_bulanan[$bulan] = (float)$row['total'];
        }
    }
    ...
    <div class="dashboard-container">
        ...
        <aside class="owner-sidebar">
            ...
            <div class="sidebar-menu-list">
                ...
                <a href="../proses/ekspor_pdf.php" target="_blank" class="sidebar-item sidebar-item-export pdf" title="Unduh Laporan PDF">
