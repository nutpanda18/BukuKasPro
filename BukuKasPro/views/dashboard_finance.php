<?php
// ==========================================================================
// SMART COOKIE GUARD GATEKEEPER (AUTOMATED REROUTING)
// ==========================================================================
...
// Pull the user ID context directly out of the client-side cookie storage
                ...
                <div id="tab-buku-besar" class="form-view-panel active">
                    <div class="workspace-card">
                        ...
                        <form action="../proses/proses_transaksi.php" method="POST" enctype="multipart/form-data" class="input-stack">
                            ...
                            <div class="field-group">
                                <label class="field-label">Lampiran Nota</label>
